...
|---|---|---|---|
| `paper` | Page background, default node fill | `#f7f9fc` (cool paper) | `#1f2937` (deep slate) |
| `paper-2` | Diagram container bg, secondary fill | `#eaf2f8` | `#26384a` |
| `ink` | Primary text, primary stroke | `#1f2937` (deep slate) | `#f7f9fc` (cool paper) |
| `muted` | Secondary text, default arrow stroke | `#4b6277` | `#c4d3df` |
| `soft` | Sublabels, boundary labels | `#6b7c8f` | `#9fb2c3` |
| `rule` | Hairline borders | `rgba(31,78,120,0.14)` | `rgba(247,249,252,0.14)` |
| `rule-solid` | Stronger borders, baselines | `#b4c7d9` | `rgba(180,199,217,0.32)` |
| `accent` | Focal / 1–2 max per diagram | `#1f4e78` (academic navy) | `#78a9d4` |
| `accent-tint` | Fill for accent-bordered boxes | `rgba(31,78,120,0.10)` | `rgba(120,169,212,0.14)` |
| `link` | HTTP/API calls, external arrows | `#2f75b5` | `#78a9d4` |
...
|---|---|---|---|---|
| `title` | Noto Serif SC / SimSun | 1.75rem | 600 | Page H1 |
| `node-name` | Noto Sans SC / Microsoft YaHei | 12px | 600 | Human-readable labels |
| `sublabel` | Geist Mono / Microsoft YaHei | 9px | 400 | Port, protocol, URL, field type |
| `eyebrow` | Geist Mono / Microsoft YaHei | 7–8px | 500, tracked 0.18em, uppercase | Type tags, axis labels |
| `arrow-label` | Geist Mono / Microsoft YaHei | 8px | 400, tracked 0.06em | Arrow annotations |
| `callout` | Noto Serif SC / SimSun *italic* | 14px | 400 | Editorial asides only |
