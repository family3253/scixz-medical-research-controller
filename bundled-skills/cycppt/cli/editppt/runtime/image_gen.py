#!/usr/bin/env python3
"""Unified CLI for cycppt image generation or editing.
...
def _cli_reinstall_hint() -> str:
    return "`pipx install --force --editable <path-to-cycppt>/cli`"
...
def _dependency_hint(package: str, *, upgrade: bool = False) -> str:
    ...
    return (
        "Install cycppt with pipx so CLI dependencies are installed, for example "
...
asset sheets, and batch image jobs in cycppt runs.
""",
