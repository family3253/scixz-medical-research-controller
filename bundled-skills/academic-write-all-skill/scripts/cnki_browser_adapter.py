...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run the bundled CNKI browser workflow through the generic workstation adapter."
    )
    ...
    config = (
        ...
        if args.config
        else script_dir.parent / "assets" / "templates" / "cnki_browser_workflow.json"
    )
    cmd = [
        sys.executable,
