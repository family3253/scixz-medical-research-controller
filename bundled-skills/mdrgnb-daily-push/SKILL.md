...
- 项目根：`/home/<USER>/.openclaw/workspace/mdrgnb_proj`
- 去重文件：`/home/<USER>/.openclaw/workspace/mdrgnb_proj/evaluated_papers.json`
- 单篇输出：`/home/<USER>/.openclaw/workspace/mdrgnb_proj/papers/<pmid>/`
  - `summary.md`
  - `scores.md`
