...
import { PAPER_SEARCH_OUTPUT_SCHEMA, compact, paperSearchMeta, presentPaperSearchCall, presentPaperSearchResult, renderPaperSearch, } from '../paper.js';
...
const SORT_BY = { relevance: 'relevance', lastUpdatedDate: 'lastUpdatedDate', submittedDate: 'submittedDate' };
...
export function arxivIdFromUrl(idUrl) {
 ...
 */
export async function runArxivSearch(runtime, params, signal) {
 ...
 */
export function applyArxivTools(ctx, runtime, fullText) {
